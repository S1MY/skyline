    ...
    <div class="page">
        ...
        <div class="content">
            <div class="contentWrapper">
                <h1 class="pageTitle">@lang('cabinet.navigation.bonus')</h1>
                @if ( Auth::user()->isAdmin() )
                <link rel="stylesheet" href="/assets/css/admin.css">
                <div class="adminItem">
                    <p class="adminText">@lang('cabinet.bonus.adminText')</p>
                    <form class="adminForm">
                        <textarea name="msg_ru" placeholder="@lang('cabinet.bonus.msg_ru')"></textarea>
                        <textarea name="msg_en" placeholder="@lang('cabinet.bonus.msg_en')"></textarea>
                        <textarea name="msg_ge" placeholder="@lang('cabinet.bonus.msg_de')"></textarea>
                        <input type="date" placeholder="@lang('cabinet.bonus.input')">
                        <button class="btn">@lang('cabinet.bonus.btn')</button>
                    </form>
                </div>
                @endif
                <div class="messageWrapper">
                    <div class="messageItem _reded">
                        <p class="messageText"><span class="_bold">Предложение недели</span> — 5 Партнеров в пакет <span class="_econom">Эконом-БОНУС</span> от компании 200 евро на ваш кошелек</p>
                        <p class="messageDate">до 29.01.2022</p>
                    </div>
                    <div class="messageItem _reded">
                        <p class="messageText"><span class="_bold">Предложение недели</span> — 5 Партнеров в пакет <span class="_econom">Эконом-БОНУС</span> от компании 200 евро на ваш кошелек</p>
                        <p class="messageDate">до 29.01.2022</p>
