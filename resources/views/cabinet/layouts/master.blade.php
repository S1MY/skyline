    ...
    @else
        <header class="header">
            <div class="headerWrapper displayFlex alignItemsCenter">
                ...
                <p class="langChanger">
                    <span class="currentLang">@lang('cabinet.header_btn.language'): <span class="lang">EN</span></span>
                    <span class="changer">
                        <a href="{{ route('locale', 'ru') }}" class="langLink" data-lang="ru"><svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('locale', 'en') }}" class="langLink _active" data-lang="en"><svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
