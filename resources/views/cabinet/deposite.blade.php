                    ...
                    <div class="customTable">
                        ...
                        @foreach ($operations as $operation)
                            <div class="customTableLine">
                                <p class="customTableItem" aria-label="Номер">{{ $operation->id }}</p>
                                <p class="customTableItem" aria-label="Дата и время">{{ $operation::getCurrentDate($operation->created_at) }}</p>
                                <p class="customTableItem" aria-label="Операция"><span><span class="_greened">+{{ $operation->value }}€</span></span></p>
                            </div>
                        @endforeach
                    </div>
                @else
