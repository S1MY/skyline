    ...
    <div class="page">
        ...
        <div class="content">
            <div class="contentWrapper">
                <h1 class="pageTitle">@lang('cabinet.deposit.title')</h1>
                <div class="pageStat displayFlex spaceBetween alignItemsCenter flexWrap">
                    <div class="pageStatItem">
                        ...
                        <div class="statRight">
                            <p class="statName">@lang('cabinet.deposit.balance')</p>
                    ...
                    <div class="pageStatItem">
                        ...
                        <div class="statRight">
                            <p class="statName">@lang('cabinet.deposit.all_deposit')</p>
                            <p class="statCount">{{ $depositSum }}€</p>
                        </div>
                    </div>
                    <div class="pageStatItem">
                        ...
                        <div class="statRight">
                            <p class="statName">@lang('cabinet.deposit.count_deposit')</p>
                            <p class="statCount">{{ $depositsCount }}</p>
                        </div>
                    </div>
                </div>
                <p class="pageText">@lang('cabinet.deposit.sub_title')</p>
                <form class="contentForm _deposit" id="deposite" action="{{ route('pay') }}">
                    <input type="text" class="contentInput" name="amount" placeholder="@lang('cabinet.deposit.sum')" min="100" max="10000" required>
                ...
                @if ($operations->count() > 0)
                    <h2 class="pageTitle">@lang('cabinet.deposit.table.title')</h2>
                    <div class="customTable">
                        <div class="customTableLine customTableHead">
                            <p class="customTableItem">@lang('cabinet.deposit.table.number')</p>
                            <p class="customTableItem">@lang('cabinet.deposit.table.date_time')</p>
                            <p class="customTableItem">@lang('cabinet.deposit.table.sum')</p>
                        </div>
                        @foreach ($operations as $operation)
                            <div class="customTableLine">
                                <p class="customTableItem" aria-label="@lang('cabinet.deposit.table.number')">{{ $operation->id }}</p>
                                <p class="customTableItem" aria-label="@lang('cabinet.deposit.table.date_time')">{{ $operation::getCurrentDate($operation->created_at) }}</p>
                                <p class="customTableItem" aria-label="@lang('cabinet.deposit.table.sum')"><span><span class="_greened">+{{ $operation->value }}€</span></span></p>
                            </div>
                        @endforeach
                    </div>
                @else
                    ...
                    <div class="customTable">
                        ...
                        <div class="customTableLine">
                            <p class="customTableItem _w100">@lang('cabinet.deposit.table.clear_table')</p>
                        </div>
                    </div>
                @endif
            </div>
