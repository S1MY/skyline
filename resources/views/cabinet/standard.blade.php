    ...
    <div class="page">
        ...
        <div class="content">
            <div class="contentWrapper">
                <h1 class="pageTitle">@lang('cabinet.pacage.title', ['pacage'=>'Standard'])</h1>
                ...
                <h2 class="pageTitle displayFlex spaceBetween alignItemsCenter">
                    ...
                    @if ( Route::currentRouteName() != 'standard' )
                        <a href="#" class="packBack">@lang('cabinet.pacage.back')</a>
                    @endif
                </h2>
                <p class="pageText">@lang('cabinet.pacage.desc')</p>
                <div class="packageGroov">
                    <p class="groovItem">@lang('cabinet.pacage.partners_in_line.one', ['attribute' => $partnersInLine->user_first_line, 'class' => '_standard'])</p>
                    <p class="groovItem">@lang('cabinet.pacage.partners_in_line.two', ['attribute' => $partnersInLine->user_second_line, 'class' => '_standard'])</p>
                    <p class="groovItem">@lang('cabinet.pacage.partners_in_line.free', ['attribute' => $partnersInLine->user_third_line, 'class' => '_standard'])</p>
                    <p class="groovItem">@lang('cabinet.pacage.partners_in_line.four', ['attribute' => $partnersInLine->user_fourth_line, 'class' => '_standard'])</p>
                </div>
                <div class="packageUsers _standard">
                    @if ($partners->count() != 0)
