        ...
        <div class="page">
            ...
            <div class="markFlex">
                ...
                <div class="markItem">
                    ...
                    <h2 class="markName">Quos dolores et quas molestias. </h2>
                    <p class="markText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec metus vel ligula placerat pellentesque.</p>
                </div>
                <div class="markItem">
                    <img src="/image/marketing/i3.png" alt="icon">
                    <h2 class="markName">Nam libero tempore, cum soluta nobis est.</h2>
                    <p class="markText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque nec metus vel ligula placerat pellentesque.</p>
                </div>
            </div>
        </div>
            ...
            <div class="answerWrapper">
                <div class="answerItem">
                    <p class="answerHeader">
                        ...
                        <span>Есть ли на проекте ограничения на выплаты?</span>
                    ...
                    <div class="answerContent">Ограничений на выплаты у нас нет и не будет.</div>
                </div>
                <div class="answerItem">
                    <p class="answerHeader">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
